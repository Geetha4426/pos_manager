...
from bot.handlers.wallet import balance_command, balance_callback, debug_wallet_command, test_sign_command
...
def main():
    ...
    app.add_handler(CommandHandler("test_sign", test_sign_command))
